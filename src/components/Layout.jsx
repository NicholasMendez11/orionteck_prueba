...
function Layout({children}) {
    ...
    return (
        ...
        <div className="flex flex-no-wrap">
            ...
            <div className={dropdown ? "w-64 absolute sm:relative bg-[#2F76E6] shadow h-screen flex-col justify-between sm:flex":"w-64 absolute sm:relative bg-[#2F76E6] shadow h-screen md:h-screen flex-col justify-between hidden sm:flex"}>
                <div>
                    ...
                    <div className="flex items-center absolute inset-x-0 bottom-0 mb-4 px-8 ">
                        ...
                        <div>
                            <p className="text-white text-sm font-medium">Nicholas Mendez</p>
                            <p className="text-white text-xs">Sign Out</p>
                        </div>
                    </div>
                </div>

                {/* Toolbar a poner debajo de la informacion de perfil por si surge algo y quiero hacer funcionalidades adicionales. Me gusto como quedo, pero no tiene sentido ahora */}
              
                {/* <div className="px-8 bg-[#c61f1fee]">
            ...
            <div className="text-gray-600 mr-8 visible sm:hidden relative" onClick={HandleDropdown}>
